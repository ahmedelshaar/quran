    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                @endif
                <div class="card-body">
                    <form method="POST" action="{{ route('sheikh.store') }}">
                        {{ csrf_field() }}
                        <div class="row">
                            <div class="col-12">
                                <div class="mb-1">
                                    <label class="form-label" for="first-name">الاسم</label>
                                    <input type="text" id="first-name" class="form-control" name="name" placeholder="الاسم" required>
                                    @error('name')
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <input type="text" id="nickname" class="form-control" name="nickname" placeholder="الكنية">
                                </div>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="notes" rows="3" placeholder="ملاحظات" name="notes"></textarea>
                                </div>
                            </div>
                            <div class="col-12">
